...
#FINALLY WE NEED HISTOGRAMS FOR THE DISTRIBUTION OF THE NUMERIC (NON-CATEGORICAL DATA) VARIABLES - CLINICAL AND COVARIATES - DORAE TO ATTEMPT TO WRITE CODE TO DO SO FOR THESE
